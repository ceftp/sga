	...
	public static boolean fazerUploadImagem(MultipartFile imagem) {
		...
		if (!imagem.isEmpty()) {
			...
			try {
				...
				String workspaceProjeto = "/home/ifpe/workspace/SGA/WebContent/view/img";
				File dir = new File(workspaceProjeto);
				if (!dir.exists()) {
					dir.mkdirs();
				}
				// Criando o arquivo no diretório
				File serverFile = new File(workspaceProjeto + File.separator + Calendar.getInstance().getTime()
						+ " - " + nomeArquivo);
